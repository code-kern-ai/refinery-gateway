...
def upgrade():
    ...
    op.create_index(
        op.f("ix_cognition_markdown_file_created_by"),
        "markdown_file",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_markdown_file_organization_id"),
        "markdown_file",
        ["organization_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["refinery_question_project_id"], ["project.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["refinery_references_project_id"], ["project.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["refinery_relevance_project_id"], ["project.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="cognition",
    )
    ...
    op.create_index(
        op.f("ix_cognition_environment_variable_created_by"),
        "environment_variable",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_environment_variable_project_id"),
        "environment_variable",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_conversation_created_by"),
        "conversation",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_conversation_project_id"),
        "conversation",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_personal_access_token_created_by"),
        "personal_access_token",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_personal_access_token_project_id"),
        "personal_access_token",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["cognition_project_id"], ["cognition.project.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["created_by"], ["user.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["refinery_project_id"], ["project.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="cognition",
    )
    op.create_index(
        op.f("ix_cognition_refinery_synchronization_task_cognition_project_id"),
        "refinery_synchronization_task",
    ...
    op.create_index(
        op.f("ix_cognition_refinery_synchronization_task_created_by"),
        "refinery_synchronization_task",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_refinery_synchronization_task_refinery_project_id"),
        "refinery_synchronization_task",
        ["refinery_project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_strategy_created_by"),
        "strategy",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_strategy_project_id"),
        "strategy",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_message_conversation_id"),
        "message",
        ["conversation_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_message_created_by"),
        "message",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_message_project_id"),
        "message",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_message_strategy_id"),
        "message",
        ["strategy_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_strategy_step_created_by"),
        "strategy_step",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_strategy_step_project_id"),
        "strategy_step",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_strategy_step_strategy_id"),
        "strategy_step",
        ["strategy_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_llm_step_created_by"),
        "llm_step",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_llm_step_project_id"),
        "llm_step",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_llm_step_strategy_step_id"),
        "llm_step",
        ["strategy_step_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_pipeline_logs_created_by"),
        "pipeline_logs",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_pipeline_logs_message_id"),
        "pipeline_logs",
        ["message_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_pipeline_logs_project_id"),
        "pipeline_logs",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_pipeline_logs_strategy_step_id"),
        "pipeline_logs",
        ["strategy_step_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_python_step_created_by"),
        "python_step",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_python_step_project_id"),
        "python_step",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_python_step_strategy_step_id"),
        "python_step",
        ["strategy_step_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_retriever_created_by"),
        "retriever",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_retriever_project_id"),
        "retriever",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_retriever_strategy_step_id"),
        "retriever",
        ["strategy_step_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_retriever_part_created_by"),
        "retriever_part",
        ["created_by"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_retriever_part_project_id"),
        "retriever_part",
        ["project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_cognition_retriever_part_retriever_id"),
        "retriever_part",
        ["retriever_id"],
        unique=False,
        schema="cognition",
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_cognition_refinery_synchronization_task_refinery_project_id"),
        table_name="refinery_synchronization_task",
        schema="cognition",
    )
    op.drop_index(
        op.f("ix_cognition_refinery_synchronization_task_created_by"),
