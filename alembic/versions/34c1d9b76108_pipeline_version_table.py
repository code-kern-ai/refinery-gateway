...
def upgrade():
    ...
    op.create_index(op.f('ix_cognition_pipeline_version_organization_id'), 'pipeline_version', ['organization_id'], unique=False, schema='cognition')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_cognition_pipeline_version_organization_id'), table_name='pipeline_version', schema='cognition')
