...
def upgrade():
    ...
    op.create_index(
        op.f("ix_refinery_synchronization_task_cognition_project_id"),
        "refinery_synchronization_task",
        ["cognition_project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_refinery_synchronization_task_refinery_project_id"),
        "refinery_synchronization_task",
        ["refinery_project_id"],
        unique=False,
        schema="cognition",
    ...
    op.create_index(
        op.f("ix_refinery_synchronization_task_created_by"),
        "refinery_synchronization_task",
        ["created_by"],
        unique=False,
        schema="cognition",
